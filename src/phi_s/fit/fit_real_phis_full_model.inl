 ...
 *          |-> mu+ mu-
 * 
 *  Fit with real dataset and full analytic model, i.e. signal plus
 *  experimental artifacts (tagging, time resolution and acceptances) with
 *  analytical convolution and integration.
 *---------------------------------------------------------------------------*/

#ifndef FIT_REAL_PHIS_FULL_MODEL_INL_
#define FIT_REAL_PHIS_FULL_MODEL_INL_
...
#include <medusa/phi_s/phis_full/ImportDataset.h>
...
#endif // FIT_REAL_PHIS_FULL_MODEL_INL_