# define the function ADD_TARGET_BENCHMARKS(target_name)
function(ADD_TARGET_BENCHMARKS target_name)
        ...
        if(BUILD_CUDA_TARGETS)
                message(STATUS "Adding target ${target_name} to CUDA backend. Executable file name: ${target_name}_cuda")
                 ...
                 cuda_add_executable("${target_name}_cuda"
                        #EXCLUDE_FROM_ALL 
                        "${CMAKE_CURRENT_SOURCE_DIR}/src/benchmarks/${target_name}.cu"    
        ...
        if(BUILD_TBB_TARGETS)
                 ...
                 add_executable("${target_name}_tbb"
                        # EXCLUDE_FROM_ALL
                        "${CMAKE_CURRENT_SOURCE_DIR}/src/benchmarks/${target_name}.cpp")
...
endfunction(ADD_TARGET_BENCHMARKS)  
