...
#ifndef PHISSIGNAL_H_
#define PHISSIGNAL_H_
...
namespace medusa {
    ...
    /*
    *  @class PhisSignal
    *  Functor that provides the time dependent formula used in phi_s analysis (see Eq. (9) on arXiv:1906.08356v4)
...
// Medusa
#include<medusa/phi_s/details/Update_ATCoefficients.inl>
